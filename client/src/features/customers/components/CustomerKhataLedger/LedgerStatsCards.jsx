...
export default function LedgerStatsCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2.5 mb-3">
      {/* Opening Balance */}
      <Card className="bg-white p-3 rounded-xl border border-slate-200/80 shadow-xs flex items-center justify-between">
        <div>
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
            OPENING BALANCE
          </span>
          <div className="text-base font-black text-slate-800 mt-0.5 tabular">
      ...
      <Card className="bg-white p-3 rounded-xl border border-slate-200/80 shadow-xs flex items-center justify-between">
        <div>
          ...
          <div className="text-base font-black text-rose-600 mt-0.5 tabular">
      ...
      <Card className="bg-white p-3 rounded-xl border border-slate-200/80 shadow-xs flex items-center justify-between">
        <div>
          ...
          <div className="text-base font-black text-emerald-600 mt-0.5 tabular">
      ...
      {/* Current Balance (Due) */}
      <Card className="bg-white p-3 rounded-xl border border-rose-200 bg-rose-50/20 shadow-xs flex items-center justify-between">
        <div>
          <span className="text-[10px] font-bold text-rose-700 uppercase tracking-wider">
            CURRENT BALANCE (DUE)
          </span>
          <div className="text-base font-black text-rose-700 mt-0.5 tabular">
