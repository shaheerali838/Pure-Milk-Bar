...
import { Eye, Plus, ShoppingCart, CheckCircle2, Calendar } from 'lucide-react';
    ...
    <div className="bg-white p-3 rounded-xl border border-slate-200/80 shadow-xs space-y-2 mb-3">
      ...
      <div className="flex flex-wrap items-center justify-end gap-1.5 pt-1.5 border-t border-slate-100">
        ...
        <Button
          ...
          disabled={!selectedCustomerId}
          className="flex items-center gap-1 px-3 py-1 h-7 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-bold shadow-xs transition disabled:opacity-50 cursor-pointer"
        >
        ...
        <Button
          ...
          disabled={!selectedCustomerId}
          className="flex items-center gap-1 px-2.5 py-1 h-7 rounded-full border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-700 text-[11px] font-semibold transition disabled:opacity-50 cursor-pointer"
        >
