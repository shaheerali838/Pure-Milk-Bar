      ...
      <div className="p-2.5 border-t border-slate-100 bg-slate-50/70 space-y-2">
        ...
        {user ? (
          <div className="relative" ref={profileMenuRef}>
            ...
            {isProfileOpen && (
              <div className="absolute bottom-[calc(100%+8px)] left-0 right-0 z-50 bg-white rounded-2xl border border-slate-200/90 shadow-2xl p-3.5 space-y-3 animate-in fade-in zoom-in-95 duration-150">
                {/* Header Profile Row */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="w-9 h-9 rounded-full bg-[#00a86b] text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-sm">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] text-slate-500 truncate max-w-[130px]" title={user.email}>
                        {user.email}
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-0.5">
                  <Link
                    to="/settings"
                    onClick={() => setIsProfileOpen(false)}
                    className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:text-slate-900 hover:bg-slate-50 transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:text-slate-900 hover:bg-slate-50 transition-colors cursor-pointer text-left"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-xs font-bold text-red-600 hover:bg-red-50 transition-colors cursor-pointer text-left"
                  >
            ...
            <div
              ...
              className={`w-full flex items-center justify-between p-2 rounded-2xl bg-white border transition-all cursor-pointer shadow-xs select-none ${
                isProfileOpen ? 'border-black ring-1 ring-black/80' : 'border-black hover:border-slate-800'
              }`}
            >
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="w-9 h-9 rounded-full bg-[#00a86b] text-white flex items-center justify-center font-bold text-sm shrink-0 relative shadow-2xs">
                  <span>{user.avatar ? user.avatar[0] : (user.name ? user.name[0] : 'S')}</span>
                  <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-[#00c980] border-2 border-white rounded-full"></span>
                </div>
